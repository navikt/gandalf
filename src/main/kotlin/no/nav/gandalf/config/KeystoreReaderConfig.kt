...
class KeystoreReaderConfig
    @Autowired
    constructor(
        @param:Value("\${nav.keystore.file}") val keystoreFile: String?,
        @param:Value("\${nav.keystore.password}") val keystorePassword: String,
        @param:Value("\${spring.profiles.active}") val profile: String,
    ) {
